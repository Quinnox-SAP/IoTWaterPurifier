sap.ui.define([
	...
	return Controller.extend("com.controller.pHOutput", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.view.pHOutput
		 */
		onInit: function () {
			this.bRenderChart = true;
			this.bNavMp = false;
			var oRouter = this.getOwnerComponent().getRouter();
			oRouter.getRoute("pHOutput").attachMatched(this._onRouteMatched, this);
			...
			// console.log(sap.ui.getCore().sThingId);
			...
			if (sNavFrom === "events" && this.eventsContext) {
				...
				// this._renderChart(oChart, sap.ui.getCore().thingId);
